      ...
      <section className="why-us section-bg fade-up backend-development">
        <div className="section-title2">
          <span className="dev-border">
            <div className=" contact_us1 ">BackEnd Development</div>
          </span>
        </div>
          ...
          <Row>
              ...
              <div className="pb-4">
                ...
                <div className="development-heading-div d-flex justify-content-between">
                  <span className="heding-title-span">
                    <h1 className="heading-title">BACKEND DEVELOPMENT COURSE</h1>
                  </span>
                ...
                <div className="development-content">
                  <p>
                    Are you ready to become a proficient backend developer? We're dedicated to helping you become a backend development expert.
                  </p>
                  <p>
                ...
                <ul>
                  <li>
                    ...
                    >
                      ...
                      <p><ChevronDoubleRight className="service-icon" /> Environment and setup Node.js</p>
                      <p><ChevronDoubleRight className="service-icon" /> Asynchronous JavaScript (Callbacks, Promises, Async/Await) </p>
                      <p><ChevronDoubleRight className="service-icon" /> Modules in Node.js (Built-in Modules vs. External Modules)</p>
                      <p><ChevronDoubleRight className="service-icon" /> Express.js (Routing, Middleware)</p>
                      <p><ChevronDoubleRight className="service-icon" /> HTTP Request and Response </p>
                      <p><ChevronDoubleRight className="service-icon" /> RESTful API Development with Express.js </p>
                      <p><ChevronDoubleRight className="service-icon" /> Handling Forms and Form Validation</p>
                      <p><ChevronDoubleRight className="service-icon" /> Node JS with MYSQL/Mongo DB</p>
                      <p><ChevronDoubleRight className="service-icon" /> Advanced Database Operations (Aggregation, Indexing)</p>
                      <p><ChevronDoubleRight className="service-icon" /> Authentication and Authorization</p>
                      <p><ChevronDoubleRight className="service-icon" /> REST API Security (JWT, OAuth)</p>
                      <p><ChevronDoubleRight className="service-icon" /> Unit Testing and Test-Driven Development (TDD) in Node.js</p>
                      <p><ChevronDoubleRight className="service-icon" /> Microservices Architecture with Node.js</p>
                      <p><ChevronDoubleRight className="service-icon" /> Performance Optimization Techniques (Caching, Load Balancing)</p>
                      <p><ChevronDoubleRight className="service-icon" /> Deployment</p>
                  ...
                  <li>
                    ...
                    >
                      <p>
                        <strong>Basic & Advanced Training Course Topics</strong>
                  ...
                  <li>
                    ...
                    >
                      ...
                      <p><ChevronDoubleRight className="service-icon" />Environment and setup CodeIgniter</p>
                      <p><ChevronDoubleRight className="service-icon" /> Models and Database Interaction</p>
                      <p><ChevronDoubleRight className="service-icon" /> Routing, Forms and Form Validation, FIle Uploading</p>
                      <p><ChevronDoubleRight className="service-icon" /> Sessions and Cookies Management</p>
                      <p><ChevronDoubleRight className="service-icon" /> Error Handling and Debugging in CodeIgniter</p>
                      <p><ChevronDoubleRight className="service-icon" /> Basic Security Practices in CodeIgniter</p>
                      <p><ChevronDoubleRight className="service-icon" /> CodeIgniter Drivers, Custom Libraries and Custom Helpers</p>
                      <p><ChevronDoubleRight className="service-icon" /> RESTful APIs in CodeIgniter</p>
                      <p><ChevronDoubleRight className="service-icon" /> Authentication and Authorization</p>
                      <p><ChevronDoubleRight className="service-icon" /> Role-Based Access Control (RBAC) Implementation</p>
                      <p><ChevronDoubleRight className="service-icon" /> Caching Techniques (Page Caching, Data Caching)</p>
                      <p><ChevronDoubleRight className="service-icon" /> Database Transactions and Query Builder</p>
                      <p><ChevronDoubleRight className="service-icon" /> Security Best Practices (Cross-Site Request Forgery, Cross-Site Scripting)</p>
                      <p><ChevronDoubleRight className="service-icon" /> Performance Optimization Techniques</p>
                      <p><ChevronDoubleRight className="service-icon" /> Unit Testing and Deployment</p>
                  ...
                  <li>
                    ...
                    >
                      ...
                      <p><ChevronDoubleRight className="service-icon" /> Object-Oriented Programming (OOP) in PHP</p>
                      <p><ChevronDoubleRight className="service-icon" /> MySQL Database and complex SQL Queries</p>
                      <p><ChevronDoubleRight className="service-icon" /> Environment  and setup Laravel via Composer</p>
                      <p><ChevronDoubleRight className="service-icon" /> Routing in Laravel,Blade Templating Engine</p>
                      <p><ChevronDoubleRight className="service-icon" /> Eloquent ORM (Object-Relational Mapping)</p>
                      <p><ChevronDoubleRight className="service-icon" /> Database Migrations and Seeding</p>
                      <p><ChevronDoubleRight className="service-icon" /> Query Builder and Raw SQL Queries</p>
                      <p><ChevronDoubleRight className="service-icon" /> Form Handling and Validation, Authentication and Authorization Basics</p>
                      <p><ChevronDoubleRight className="service-icon" /> Middleware, Error Handling and Debugging in Laravel</p>
                      <p><ChevronDoubleRight className="service-icon" /> RESTful API Development, Resourceful Controllers and Resource Routing</p>
                      <p><ChevronDoubleRight className="service-icon" /> Advanced Eloquent Techniques (Scopes, Accessors, Mutators)</p>
                      <p><ChevronDoubleRight className="service-icon" /> Task Scheduling and Cron Jobs in Laravel</p>
                      <p><ChevronDoubleRight className="service-icon" /> Queues and Background Processing</p>
                      <p><ChevronDoubleRight className="service-icon" /> Laravel Events and Listeners</p>
                      <p><ChevronDoubleRight className="service-icon" /> Performance Optimization Techniques (Caching, Eager Loading)</p>
                      <p><ChevronDoubleRight className="service-icon" /> Unit Testing and Deployment and Deployment</p>
            ...
            >
              ...
              <div className="popular-coarses mt-4">
                ...
                </span>                <div class="icon-box-content ">
...
export default React.memo(BackendDevelopment)
