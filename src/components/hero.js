...
const slides = [
  {
    ...
    title: "Transform Your Business with Web & Mobile Apps",
    subtitle:
      "We develop high-quality websites and mobile apps tailored to your business needs, ensuring performance, scalability, and a seamless user experience.",
  },
  {
    id: "slide-2",
    image: ProductImage,
    ...
    title: "Enterprise Software That Grows With You",
    subtitle:
      "Transform your business with our comprehensive suite of ERP, CRM, HMS, HRMS and e-commerce solutions.Built for scale, designed for success.",
  },
  {
    id: "slide-3",
    image: banner1,
    alt: "mobile-app",
    title:
      "Developing robust applications for both iOS and Android platforms.",
    subtitle:
      "We prioritize user experience to create apps that users love and engage with effortlessly",
  },
  {
    id: "slide-4",
    image: banner4,
    alt: "ecommerce",
    title:
      "Make Your Online Presence with Website development services",
    subtitle:
      "We specialize in responsive, scalable, and future-ready solutions for Web.",
  },
  {
    id: "slide-5",
    image: banner2,
    alt: "web design",
    title:
      "Seamless Fusion of Design Excellence and Technical Prowess",
    subtitle:
      "Our designs prioritize user experience, ensuring your audience stays engaged and converts.",
  },
  {
    id: "slide-6",
    image: banner3,
    ...
    title: "CMS based Website development and designing",
    subtitle:
      "Popular CMS options include WordPress, Joomla, Squarespace, Wix and many others.",
  },
];
...
function Hero() {
  return (
    <div id="hero" className="align-items-center">
      ...
      >
        {slides.map((slide, index) => (
          <Carousel.Item key={slide.id} id={slide.id}>
            <Image
